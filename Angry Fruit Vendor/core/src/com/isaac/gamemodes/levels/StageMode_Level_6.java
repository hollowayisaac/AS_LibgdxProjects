 ...
 */
public class StageMode_Level_6 extends _Level {

    // Level 1
    // Save 15 fruits
    protected  int fruitsSaved;
    protected final int FRUIT_GOAL = 40;
    protected final int STARTING_LIVES = 5;

    public StageMode_Level_6(_GameMode gameMode){
        super(gameMode);
        fruitsSaved = 0;
    }
    ...
    protected void setAllowedFruitsForLevel() {
        ...
        allowedFruits.put(Fruit.FruitType.Orange, 15);
        ...
        allowedFruits.put(Fruit.FruitType.Basket, 25);
    }
